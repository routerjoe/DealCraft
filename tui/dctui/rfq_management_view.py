...
class RFQManagementScreen(Screen):
    ...
    async def action_gen_internal_email(self):
        ...
        try:
            ...
            result = await asyncio.to_thread(self._call_tool, "create_rfq_drafts", {"rfq_id": int(rfq_id)})
    ...
    async def action_gen_oem_email(self):
        ...
        try:
            ...
            result = await asyncio.to_thread(self._call_tool, "rfq_draft_oem_registration", {"rfq_id": int(rfq_id)})
